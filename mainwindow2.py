...
"    border-radius: 5px;\n"
"    padding: 3px;\n"
"    background-color: qlineargradient(spread:reflect, x1:0.528, y1:0.971591, x2:0.528955, y2:0.506, stop:0 rgba(200, 0, 0, 255), stop:1 rgba(255, 255, 255, 255));\n"
"}\n"
"\n"
"QPushButton:hover{\n"
"    border-radius: 5px;\n"
...
"}")
        ...
        self.buttonGroup.addButton(self.bRadioState)
...
"}")
        ...
        self.buttonGroup.addButton(self.bAudioState)
...
"}")
        ...
        self.buttonGroup.addButton(self.bVideoState)
...
"}")
        ...
        self.buttonGroup_2.addButton(self.pbPrevious)
...
"}")
        ...
        self.buttonGroup_2.addButton(self.pbInBegin)
...
"}")
        ...
        self.buttonGroup_2.addButton(self.pbPlay)
...
"}")
        ...
        self.buttonGroup_2.addButton(self.pbStop)
...
"}")
        ...
        self.buttonGroup_2.addButton(self.pbNext)
...
"}")
        ...
        MainWindow.setTabOrder(self.pbInBegin, self.bRadioState)
        MainWindow.setTabOrder(self.bRadioState, self.bAudioState)
        MainWindow.setTabOrder(self.bAudioState, self.hsVolumeSlider)
        MainWindow.setTabOrder(self.hsVolumeSlider, self.pbVolume)
        MainWindow.setTabOrder(self.pbVolume, self.pbPlay)
        MainWindow.setTabOrder(self.pbPlay, self.pbStop)
        MainWindow.setTabOrder(self.pbStop, self.pbNext)
        MainWindow.setTabOrder(self.pbNext, self.bVideoState)
        MainWindow.setTabOrder(self.bVideoState, self.hsMusicSlider)
        MainWindow.setTabOrder(self.hsMusicSlider, self.pbPrevious)
        MainWindow.setTabOrder(self.pbPrevious, self.pushButton_2)
        MainWindow.setTabOrder(self.pushButton_2, self.pbOpenWindow)
        MainWindow.setTabOrder(self.pbOpenWindow, self.tvPlaylist)
        MainWindow.setTabOrder(self.tvPlaylist, self.pbAddMusic)
        MainWindow.setTabOrder(self.pbAddMusic, self.pbDelMusic)
        MainWindow.setTabOrder(self.pbDelMusic, self.pbPlaylists)
        MainWindow.setTabOrder(self.pbPlaylists, self.pbSort)
        MainWindow.setTabOrder(self.pbSort, self.leFind)
        MainWindow.setTabOrder(self.leFind, self.pbFind)
        MainWindow.setTabOrder(self.pbFind, self.pbSettings)
        MainWindow.setTabOrder(self.pbSettings, self.pushButton)
